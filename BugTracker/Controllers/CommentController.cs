	...
	public class CommentController : Controller
	{
		...
		public async Task<IActionResult> Create(CreateCommentViewModel model)
		{
			if (ModelState.IsValid)
			{
				...
				string bugReportUrl = Url.Action("Overview", "BugReport", new { bugReportId = addedComment.BugReportId}, Request.Scheme);
				await subscriptions .NotifyBugReportNewComment(addedComment, bugReportUrl);

				return RedirectToAction("Overview", "BugReport", new { bugReportId = addedComment.BugReportId});
			}
		...
		public async Task<IActionResult> Edit(Comment viewModel)
		{
			if (ModelState.IsValid)
			{
				...
				return RedirectToAction("Overview", "BugReport", new { bugReportId = comment.BugReportId});
			}
		...
		public async Task<IActionResult> Delete(int commentId)
		{
			...
			return RedirectToAction("Overview", "BugReport", new { bugReportId = parentBugReportId });
		}
	}
}
